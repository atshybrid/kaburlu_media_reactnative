...
This is the Kaburlu mobile application built with [Expo](https://expo.dev) and React Native. Kaburlu is a news platform that empowers citizen journalism and provides real-time news updates.
